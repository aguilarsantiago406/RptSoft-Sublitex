-- =============================================================================
-- SIPES — Restricciones que Prisma no puede expresar
--
...
--
-- Estas cinco reglas son la diferencia entre un sistema que evita los errores
-- del pedido PROMO 2002 y uno que sólo los documenta. Ninguna se puede dejar
-- en el servicio: en Arte Ideas las validaciones vivían en la vista, y por eso
-- un superusuario leía los clientes de otro tenant.
-- =============================================================================
